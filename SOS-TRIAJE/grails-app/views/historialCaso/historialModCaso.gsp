                    ...
                    <table>
                        <tbody>
                          ...
                          <tr class="prop">
                            ...
                            <td valign="top" class="value">${CasoInstance.descripcion}</td>                            
                          </tr>                          
                          ...
                          <tr class="prop">
                            <td valign="top" class="name">
                              <label for="especialidades"><g:message code="especialidad.label" default="Especialidad" /></label>
                            </td>
                            <td valign="top" class="value ${hasErrors(bean: CasoInstance, field: 'medico', 'errors')}">
                              <g:select name="especialidad"  class="selectci"  from="${especialidad.Especialidad.list()}" optionKey="id" optionValue="nombre" value="id" onchange="mostrarEspecialistas(this.value)" />
                            </td>
                          </tr>
                          --%>
                          ...
                          <tr class="prop">
                            ...
                            <td valign="top" class="value ${hasErrors(bean: CasoInstance, field: 'medico', 'errors')}">
                              <g:select name="especialidades" disabled="false" noSelection="['':'Seleccione']"  from="${especialidadList}" optionKey="id" optionValue="nombre" value="id" onclick="mostrarEspecialistas(this.value)" />
                            </td>
                          </tr>
                          ...
                          <tr class="prop">
                            ...
                            <td valign="top" class="value ${hasErrors(bean: CasoInstance, field: 'medico', 'errors')}">
                              <g:select name="medico" id="medicos" value="${params.nombre}"  disabled="false" noSelection="['':'Seleccione']"/>
                            </td>
                          </tr>
