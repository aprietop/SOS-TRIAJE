           ...
           <table class="tabla2">
                    ...
                    <g:each in="${historialCasoInstanceList}" status="i" var="historialCasoInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td style="width:160px;"><g:formatDate format="dd-MM-yyyy HH:mm a" date="${historialCasoInstance.fecha}"/></td>
                            
                            <td style="width:360px;" class="pJustifica"><g:encodeAs codec="NL2BR">${historialCasoInstance.caso.descripcion}</g:encodeAs></td>
