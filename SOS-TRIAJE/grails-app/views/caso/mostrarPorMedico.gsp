...
<g:actionSubmit action="mostrarPorMedico" value="Todos" class="boton1"/>
          ...
          <g:each in="${historialCasoInstanceList}" status="i" var="historialCasoList">
              ...
              <g:each in="${historialCasoList}" status="j" var="historialCasoInstance">
                <tr>
                  ...
                  <td style="width:75px;"><g:formatDate format="dd-MM-yyyy HH:mm a" date="${historialCasoInstance.caso.fechaSolucion}"/></td>
