            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="centroSOS.id.label" default="Id" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="centroSOS.nombre.label" default="Nombre" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="centroSOS.url.label" default="Url" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="centroSOS.uuid.label" default="Uuid" /></td>
