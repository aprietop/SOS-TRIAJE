...
//        casoInstanceList = triajeService.getAllCasosPorStatus(status4)
//        
...
//                        html    "Notificacion: "+trato+" "+primerHistorial.medico.nombre+" "+primerHistorial.medico.apellido+", se le recuerda revisar el caso numero "+primerHistorial.caso.id+" que le fue asignado como solicitud de segunda opinion, Gracias."
//                    }
//                }catch(Exception e){
...
//                        html    "Notificacion: "+trato+" "+primerHistorial.medico.nombre+" "+primerHistorial.medico.apellido+", se le informa que el caso numero "+primerHistorial.caso.id+" que le fue asignado como peticion de segunda opinion ha sido devuelto automaticamente a su especialista asignado debido al atraso en su respuesta, Gracias"
//                    }
//                }catch(Exception e){
//                    println "Error de conexion"
//                    e.printStackTrace()
